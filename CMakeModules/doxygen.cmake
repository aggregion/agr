configure_file("agr.doxygen.in" "${CMAKE_BINARY_DIR}/agr.doxygen")
...
if(NOT DOXYGEN_FOUND)
  ...
  set(DOXY_AGR_VERSION "${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_PATCH}" CACHE INTERNAL "Version string used in PROJECT_NUMBER.")
  ...
  if(BUILD_DOXYGEN)
    ...
    add_custom_target(contract_documentation ALL
      COMMAND "${DOXYGEN_EXECUTABLE}" "${CMAKE_BINARY_DIR}/agr.doxygen"
