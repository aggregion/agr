...
#include "agrio_system_tester.hpp"
...
BOOST_FIXTURE_TEST_CASE( buysell, agrio_system_tester ) try {
   ...
   transfer( "agrio", "alice1111111", core_from_string("1000.0000"), "agrio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "agrio", "alice1111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( initial_ram_balance + core_from_string("199.0000"), get_balance(N(agrio.ram)) );
   BOOST_REQUIRE_EQUAL( initial_ramfee_balance + core_from_string("1.0000"), get_balance(N(agrio.ramfee)) );
   ...
   transfer( "agrio", "alice1111111", core_from_string("100000000.0000"), "agrio" );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, agrio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( init_agrio_stake_balance + core_from_string("300.0000"), get_balance( N(agrio.stake) ) );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, agrio_system_tester ) try {
   ...
   issue( "agrio", core_from_string("1000.0000"), config::system_account_name );
   issue( "agrio.stake", core_from_string("1000.0000"), config::system_account_name );
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111" ) );

   //agrio stakes for alice with transfer flag

   transfer( "agrio", "bob111111111", core_from_string("1000.0000"), "agrio" );
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, agrio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "agrio", "alice1111111", core_from_string("2000.0000"), core_from_string("1000.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, agrio_system_tester ) try {
   ...
   auto key =  fc::crypto::public_key( std::string("AGR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV") );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, agrio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", core_from_string("2.0000"), core_from_string("0.0002")/*"2.0000 AGR", "0.0002 AGR"*/ ) );
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, agrio_system_tester) try {
   ...
   string agrio_system_wast2 = agrio_system_wast;
   string msg = "producer votes must be unique and sorted";
   auto pos = agrio_system_wast2.find(msg);
   BOOST_REQUIRE( pos != std::string::npos );
   msg[0] = 'P';
   agrio_system_wast2.replace( pos, msg.size(), msg );

   transaction trx;
   {
      auto code = wast_to_wasm( agrio_system_wast2 );
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, agrio_system_tester ) try {
   ...
   transfer( "agrio", "alice1111111", core_from_string("600000000.0000"), "agrio" );
...
BOOST_FIXTURE_TEST_CASE( buyname, agrio_system_tester ) try {
   ...
   transfer( "agrio", "nofail", core_from_string( "1000.0000" ) );
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, agrio_system_tester ) try {
   ...
   // alice outbids bob on prefb
   {
      ...
      BOOST_REQUIRE_EQUAL( initial_names_balance + core_from_string("0.1001"), get_balance(N(agrio.names)) );
   }
