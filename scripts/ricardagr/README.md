# Purpose
The `ricardagr.py` imports or exports recardian contracts to and from a contracts abi

## Import Example
`$ python3 ricardagr.py import /path/to/sorce-contract.abi /path/to/new-smart-contract-abi.abi`
...
## Export Example
`$ python3 ricardagr.py export /path/to/sorce-contract.abi`
