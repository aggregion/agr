...
int main( int argc, char** argv ) {
   ...
   app.add_flag( "--no-auto-" + string(key_store_executable_name), no_auto_kagrd, localized("don't automatically launch a ${k} if one is not currently running", ("k", key_store_executable_name)));
...
//                                ->check(CLI::ExistingFile);
   ...
   auto stopKagrd = wallet->add_subcommand("stop", localized("Stop ${k}.", ("k", key_store_executable_name)), false);
