...
try:
    ...
    for account in accounts:
        ...
        trans=node.createInitializeAccount(account, cluster.agrioAccount, stakedDeposit=0, waitForTransBlock=False, stakeNet=1000, stakeCPU=1000, buyRAM=1000, exitOnError=True)
