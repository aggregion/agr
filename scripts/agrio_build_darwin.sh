...
if [ $COUNT -gt 1 ]; then
	...
	case $ANSWER in
		1 | [Yy]* )
			...
			brew tap agrio/agrio # Required to install mongo-cxx-driver with static library
			printf "\\nInstalling Dependencies...\\n"
			# Ignore cmake so we don't install a newer version.
			# Build from source to use local cmake; see homebrew-agrio repo for examples
