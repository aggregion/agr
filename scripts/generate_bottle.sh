...
mkdir -p ${PROJECT}/${VERSION}/opt/agrio/lib/cmake
...
echo "class Agrio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/aggregion/agr/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/aggregion/agr/releases/download/v${VERSION}\"
