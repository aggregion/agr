...
CHAINBASE_SET_INDEX_TYPE(agrio::chain::permission_object, agrio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(agrio::chain::permission_usage_object, agrio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<agrio::chain::permission_object>, (_id))
FC_REFLECT(agrio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<agrio::chain::permission_usage_object>, (_id))
FC_REFLECT(agrio::chain::permission_usage_object, (id)(last_used))
