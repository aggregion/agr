...
```
  "nodes": [[
      "testnet_0",{
        ...
        "ssh_identity": "",
        "ssh_args": "",
        "eos_root_dir": "/home/phil/blockchain/agr",
        "data_dir": "tn_data_0",
        "hostname": "remoteserv",
...
| eos_root_dir       | specifies the directory into which all agrd artifacts are based. This is required for any hosts that are not the local host.
