...
```
$ clagr system newaccount -s -j -d --transfer --stake-net "1.000 SYS" --stake-cpu "1.000 SYS" --buy-ram-kbytes 50 agrio agrio.sudo AGR5Jor6PfmbokKBBM3cMs3PitHWy6SXNCsu6fw9LoVj7BWPxHzx1 > generated_account_creation_trx.json
