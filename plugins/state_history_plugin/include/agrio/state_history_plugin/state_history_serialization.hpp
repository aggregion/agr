...
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<agrio::chain::account_object>& obj) {
   ...
   fc::raw::pack(ds, as_type<agrio::chain::digest_type>(obj.obj.code_version));
...
operator<<(datastream<ST>&                                                                                     ds,
           const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::key_value_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                   ds,
           const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::index64_object>& obj) {
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                    ds,
           const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::index128_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                    ds,
           const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::index256_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                        ds,
           const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::index_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>& operator<<(
    datastream<ST>&                                                                                             ds,
    const history_context_wrapper<const agrio::chain::table_id_object, agrio::chain::index_long_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<agrio::chain::action_trace>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   history_serialize_container(ds, obj.db, as_type<std::vector<agrio::chain::action_trace>>(obj.obj.inline_traces));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                          ds,
                           const history_context_wrapper<uint8_t, agrio::chain::transaction_trace>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<agrio::chain::transaction_id_type>(obj.obj.id));
   if (obj.obj.receipt) {
      if (obj.obj.failed_dtrx_trace &&
          obj.obj.receipt->status.value == agrio::chain::transaction_receipt_header::soft_fail)
   ...
   history_serialize_container(ds, obj.db, as_type<std::vector<agrio::chain::action_trace>>(obj.obj.action_traces));
   ...
   if (obj.obj.failed_dtrx_trace) {
      ...
      if (obj.obj.receipt && obj.obj.receipt->status.value == agrio::chain::transaction_receipt_header::soft_fail)
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<agrio::chain::transaction_trace>& obj) {
   uint8_t stat = agrio::chain::transaction_receipt_header::hard_fail;
