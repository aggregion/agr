...
{ try {
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq",
      "publickey_arr" :  ["AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq","AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq","AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq", "weight":"100"},
      "keyweight_arr": [{"key":"AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq", "weight":"100"},{"key":"AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq", "weight":100},{"key":"AGR8b2ojDi7mMWQxE3W6Fa1dr9bPfe5NTpRmyqBHECLNeFrdZHZrq", "weight":200}],
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "owner" : {
        "threshold" : 2147483145,
        "keys" : [ {"key" : "AGR8QGk4gKwUFJB94wujutAaCWHqDpf2QG6Aj85mVLJBJinoDqLd7", "weight" : 57005},
                   {"key" : "AGR8NEX4D2p8YVg5vdCMaQRGSMXn6Q8S37mBpnv7KPmBhUaZ6LeDE", "weight" : 57605} ],
        "accounts" : [ {"permission" : {"actor" : "prm.acct1", "permission" : "prm.prm1"}, "weight" : 53005 },
                       {"permission" : {"actor" : "prm.acct2", "permission" : "prm.prm2"}, "weight" : 53405 }],
        "waits" : []
     },
   ...
   BOOST_TEST("AGR8QGk4gKwUFJB94wujutAaCWHqDpf2QG6Aj85mVLJBJinoDqLd7" == (std::string)newacct.owner.keys[0].key);
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("AGR8NEX4D2p8YVg5vdCMaQRGSMXn6Q8S37mBpnv7KPmBhUaZ6LeDE" == (std::string)newacct.owner.keys[1].key);
   ...
   BOOST_TEST("AGR8QGk4gKwUFJB94wujutAaCWHqDpf2QG6Aj85mVLJBJinoDqLd7" == (std::string)newacct.active.keys[0].key);
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("AGR8NEX4D2p8YVg5vdCMaQRGSMXn6Q8S37mBpnv7KPmBhUaZ6LeDE" == (std::string)newacct.active.keys[1].key);
...
{
   using agrio::testing::fc_exception_message_starts_with;

   auto duplicate_variant_abi = R"({
      "version": "agrio::abi/1.1",
      "variants": [
...
BOOST_AUTO_TEST_CASE(version)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "agrio::abi/9.0"})").as<abi_def>(), max_serialization_time), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "agrio::abi/1.0"})").as<abi_def>(), max_serialization_time);
      abi_serializer(fc::json::from_string(R"({"version": "agrio::abi/1.1"})").as<abi_def>(), max_serialization_time);
   } FC_LOG_AND_RETHROW()
}
...
{
   using agrio::testing::fc_exception_message_is;
