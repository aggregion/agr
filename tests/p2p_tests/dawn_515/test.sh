...
read -d '' genesis << EOF
{
  ...
  "initial_key": "AGR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
plugin = agrio::net_plugin
plugin = agrio::history_api_plugin
http-server-address = 127.0.0.1:8888
blocks-dir = blocks
p2p-listen-endpoint = 0.0.0.0:9876
allowed-connection = any
private-key = ['AGR6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/agrio-launcher/agrio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clagr/clagr -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clagr/clagr -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clagr/clagr -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
