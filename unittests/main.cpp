...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("AGR_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      AGR_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "AGR_TESTING_GENESIS_TIMESTAMP is " << AGR_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
