...
class P2PTestPeers:
    ...
    ports = [8888] # agriod listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # agriod listening port of each host
